...
export default async function SummaryPage() {
  ...
  // extra safety, but (protected) layout already enforces this
  const {
    data: { user },
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-2xl bg-white rounded-xl shadow p-6 space-y-6">
        <h1 className="text-2xl font-semibold text-center">Monthly Summary</h1>
        <p className="text-sm text-gray-600 text-center">{monthLabel}</p>
